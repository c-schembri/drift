...
Drift does not manage packages, generate IDE projects, sandbox commands, or perform cross-compilation in v0. Remote execution never occurs implicitly during a local build.
