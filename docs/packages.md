...
- Package build providers execute only after locked content is materialized. Local overlays remain the recommended way to
  review and control how third-party source is compiled.
